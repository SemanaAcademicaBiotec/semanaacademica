...
const Apresentacao = () => {
  return (
    <div className='container'>
      <p className='fs-2 mt-4'><strong>Apresentação</strong></p>
      <p className='fs-4'>A Biotecnologia é uma área multidisciplinar em constante crescimento e aperfeiçoamento, onde faz-se necessária a busca constante pelo conhecimento e complementação da formação de seus profissionais. A 1ª Semana Acadêmica do Curso de Biotecnologia é um evento acadêmico-científico do curso de graduação em Biotecnologia do Centro de Desenvolvimento Tecnológico (CDTec) da Universidade Federal de Pelotas (UFPel) planejado, organizado e executado pela Comissão Organizadora composta pelo Diretório Acadêmico de Biotecnologia, juntamente com professores e alunos dos curso de graduação em Biotecnologia (G-Biotec) e do Programa de Pós-Graduação em Biotecnologia (PPGB). Este evento busca abranger temas pertinentes e de fronteira do conhecimento na área de Biotecnologia, promovendo a atualização científica, a troca de experiências, bem como a interação entre grupos de pesquisa da região .
