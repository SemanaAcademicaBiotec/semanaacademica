  ...
  return (
    <div className='container fs-5'>
      <div className='text-center'>
        <p className='fs-2 mt-4'><strong>Submissão de trabalho: Pesquisa - Graduação</strong></p>
        <br />
        <div className='lh-sm'>
    ...
    <div className='text-center border shadow p-5 m-4 mx-auto rounded-5' style={{maxWidth: '70%'}}>
      ...
      <button className='btn btn-outline-dark btn-lg mb-4 p-4 btn-roxo' onClick={() => window.open("https://forms.gle/QB541MwKnJUBMJbK9", "_blank")}>
        Submeter Resumo Expandido
      </button>
      <hr style={{width: '40%'}} className='mx-auto'/>
      <div className='fs-6'>
        <p><strong>Prazo de submissão</strong> <br /> 22/07/2025 às 00:00 até 23/10/2025 às 23:59</p>
      </div>
    </div>
    <br />
    <Regras />
