...
const Inscrever = () => {
  return (
    <div className='container text-center'>
      ...
      <p className='fs-5'>
        Para se inscrever, preencha o formulário disponível clicando no botão acima. Inscrições abertas do dia <strong>22 de julho</strong> até <strong>21 de novembro</strong>.
      </p>
