    ...
    <div className='container text-center'>
        ...
        <div className='d-flex justify-content-center mt-5'>
          <div className='border shadow p-5 rounded-5' style={{width: '500px'}}>
            ...
            <button className='btn btn-lg btn-submeta' onClick={() => navigate("/modelo/resumo-expandido")}>Baixar Modelo</button>
          </div>
          
          <div>
            <div className='border shadow p-5 ms-5 rounded-5' style={{width: '500px'}}>
              <p className='fs-4'>
                Modelo - Pôster
              </p>
              <button className='btn btn-lg btn-submeta' onClick={() => navigate("/modelo/resumo-expandido-com-poster")}>Baixar Modelo</button>
            </div>
          </div>
        </div>
